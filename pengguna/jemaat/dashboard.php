    ...
    "SELECT * FROM pelayanan
     ...
     LIMIT 5"
                ...
                background: linear-gradient(135deg,#0d6efd,#6610f2);">
                            <div class="card-body p-5 text-white">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-lg-4 text-center">
                                        <i class="fas fa-church" style="font-size:120px;opacity:0.3"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card shadow-lg border-0 mt-5" style="border-radius:20px; overflow:hidden;">
                                    ...
                                    <div class="card border-0 shadow-lg h-100 dashboard-card">
                                        <div class="card-body">
                                            <div class="d-flex justify-content-between align-items-center">
                                                ...
                                                <div class="icon-circle" style="background: <?= $details['color']; ?>;">
