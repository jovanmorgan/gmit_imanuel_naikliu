...
<div class="page-header">
    ...
    <?php if ($page_title !== "Peserta" && $page_title !== "Profile Saya" && $page_title !== "Gereja" && $page_title !== "Galery" && $page_title !== "Laporan Jemaat" && $page_title !== "Laporan Pelayanan" && $page_title !== "Laporan Sidi" && $page_title !== "Laporan Babtis" && $page_title !== "Pelayanan" && $page_title !== "Laporan Nikah"): ?>
