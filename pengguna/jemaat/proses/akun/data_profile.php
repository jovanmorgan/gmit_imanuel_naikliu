...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $check_query = "SELECT * FROM jemaat WHERE username = '$username' AND id_jemaat != '$id_jemaat'";
    ...
    $query = "UPDATE jemaat SET password='$password', nama_lengkap='$nama_lengkap', username='$username' WHERE id_jemaat='$id_jemaat'";
