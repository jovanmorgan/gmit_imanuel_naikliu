            ...
            <div class="container">
                <div class="page-inner">
                            ...
                            <div class="row">
                                <div class="col-xl-4">
                                    <div class="card">
                                        ...
                                        // Periksa apakah session id_jemaat telah diset
                                        if (isset($_SESSION['id_jemaat'])) {
                                            $id_jemaat = $_SESSION['id_jemaat'];

                                            // Query SQL untuk mengambil data jemaat berdasarkan id_jemaat dari session
                                            $query = "SELECT * FROM jemaat WHERE id_jemaat = '$id_jemaat'";
                                            $result = mysqli_query($koneksi, $query);

                                            // Periksa apakah query berhasil dieksekusi
                                            if ($result) {
                                                // Periksa apakah terdapat data jemaat
                                                if (mysqli_num_rows($result) > 0) {
                                                    // Ambil data jemaat sebagai array asosiatif
                                                    $jemaat = mysqli_fetch_assoc($result);
                                        ?>
                                        <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                                            <a href="javascript:void(0)"
                                                onclick="document.getElementById('editFotoProfile').click()">
                                                <?php if (!empty($jemaat['fp'])): ?>
                                                <img src="../../assets/img/fp_pengguna/jemaat/<?php echo $jemaat['fp']; ?>"
                                            ...
                                            <h4 class="text-center mt-3"><?php echo $jemaat['nama_lengkap']; ?></h4>
                                            <h5 class="text-center mb-2"><?php echo $jemaat['username']; ?></h5>
                                        </div>
                                    </div>
                                </div>
                                <style>
                                            ...
                                            <div class="tab-content pt-2">
                                                ...
                                                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                                                    ...
                                                    <form id="editProfileForm">
                                                        <input type="text" name="id_jemaat" id="id_jemaat"
                                                            value="<?php echo $jemaat['id_jemaat']; ?>" hidden>
                                                        <div class="row mb-3">
                                                            <label for="fullName"
                                                            ...
                                                            <div class="col-md-8 col-lg-9">
                                                                <input name="nama_lengkap" type="text"
                                                                    ...
                                                                    value="<?php echo $jemaat['nama_lengkap']; ?>" />
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-md-8 col-lg-9">
                                                                <input name="username" type="text" class="form-control"
                                                                    id="username"
                                                                    value="<?php echo $jemaat['username']; ?>" />
                                                            </div>
                                                        </div>
                                                        <div class="row mb-3">
                                                            <label for="password"
                                                            ...
                                                            <div class="col-md-8 col-lg-9">
                                                                <input name="password" type="text" class="form-control"
                                                                    id="password"
                                                                    value="<?php echo $jemaat['password']; ?>" />
                                                            </div>
                                                        </div>
                    ...
                    <?php
                                                    ...
                                                    echo "Tidak ada data jemaat.";
                                                }
                                            } else {
                                                // Jika query tidak berhasil dieksekusi
                                                echo "Gagal mengambil data jemaat: " . mysqli_error($koneksi);
                                            }
                                        } else {
                                            // Jika session id_jemaat tidak diset
                                            echo "Session id_jemaat tidak tersedia.";
                                        }
