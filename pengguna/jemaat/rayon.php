...
<body>
                        ...
                        <div class="modal-body">
                            <form id="editForm" method="POST" action="proses/<?= $current_page ?>/edit.php"
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-text"><i class="fas fa-user"></i></span>
                                        <select class="form-select" name="id_majelis" id="edit_majelis" required>
                                            <option value="" disabled selected>Pilih Majelis</option>
                                            <?php
                                            include '../../keamanan/koneksi.php';
    ...
    <script>
        function openEditModal(id, nama_rayon, id_majelis, username, password) {
            let editModal = new bootstrap.Modal(document.getElementById('editModal'));
            document.getElementById('edit_id').value = id;
            document.getElementById('edit_nama_rayon').value = nama_rayon;
            document.getElementById('edit_majelis').value = id_majelis;
