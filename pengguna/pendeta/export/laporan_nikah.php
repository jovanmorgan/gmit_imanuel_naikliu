    ...
    <div class="container" id="pdfContent">
        ...
        <div class="row kop-surat">
            ...
            <div class="col-8 text-center">
                <h4>GEREJA GMIT</h4>
                <h5>DATA NIKAH</h5>
                <p style="margin:0;">Laporan Nikah Sistem Informasi Gereja</p>
            </div>
        </div>
        ...
        <div class="table-responsive">
            <table class="table table-bordered">
                ...
                FROM nikah
                INNER JOIN jemaat ON jemaat.id_jemaat = nikah.id_jemaat
                WHERE 
            ...
            ";
                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="../../../../assets/nikah/<?= $row['surat_sidi_pengantin'] ?>"
                            ...
                            <td>
                                <a href="../../../../assets/nikah/<?= $row['surat_babtis_pengantin'] ?>"
                            ...
                            <!-- SURAT NIKAH SAKSI -->
                            <td>
                                <a href="../../../../assets/nikah/<?= $row['surat_nikah_saksi'] ?>"
                                    class="btn btn-sm btn-warning" target="_blank">
                                    Lihat Surat Nikah Saksi
                                </a>
                            </td>

                            <!-- AKTA LAHIR SAKSI -->
                            <td>
                                <a href="../../../../assets/nikah/<?= $row['akta_kelahiran_saksi'] ?>"
                            ...
                            <td>
                                <?php if (!empty($row['fp'])): ?>
                                    <a href="../../../../assets/fp/<?= $row['fp'] ?>" class="btn btn-sm btn-success"
                                        target="_blank">
                                        Lihat FP
                                    </a>
                                <?php else: ?>
