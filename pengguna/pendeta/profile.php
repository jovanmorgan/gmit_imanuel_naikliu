                                ...
                                <div class="col-xl-4">
                                    <div class="card">
                                        ...
                                        <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                                            ...
                                            <h4 class="text-center mt-3"><?php echo $pendeta['nama_lengkap']; ?></h4>
                                            <h5 class="text-center mb-2"><?php echo $pendeta['username']; ?></h5>
                                        </div>
                                    </div>
                                </div>
                                <style>
                                            ...
                                            <div class="tab-content pt-2">
                                                ...
                                                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                                                    ...
                                                    <form id="editProfileForm">
                                                        <input type="text" name="id_pendeta" id="id_pendeta"
                                                            value="<?php echo $pendeta['id_pendeta']; ?>" hidden>
                                                        <div class="row mb-3">
                                                            <label for="fullName"
                                                            ...
                                                            <div class="col-md-8 col-lg-9">
                                                                <input name="nama_lengkap" type="text"
                                                                    ...
                                                                    value="<?php echo $pendeta['nama_lengkap']; ?>" />
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-md-8 col-lg-9">
                                                                <input name="username" type="text" class="form-control"
                                                                    id="username"
                                                                    value="<?php echo $pendeta['username']; ?>" />
                                                            </div>
                                                        </div>
                                                        <div class="row mb-3">
                                                            <label for="password"
                                                            ...
                                                            <div class="col-md-8 col-lg-9">
                                                                <input name="password" type="text" class="form-control"
                                                                    id="password"
                                                                    value="<?php echo $pendeta['password']; ?>" />
                                                            </div>
                                                        </div>
